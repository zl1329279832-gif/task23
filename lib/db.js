...
const DB = (() => {
  ...
  async function reEncryptSyncQueue() {
    ...
    for (const item of items) {
      ...
      // 先尝试用当前 key 解密（changePin 后 CryptoManager 已更新为新 key）
  ...
  return {
    ...
    reEncryptSyncQueue, _cleanSnapshot
  };
})();
